...
/**
 * PostgresBinaryTupleWriterSocketEnabled is a {@link TupleWriterSocketEnabled} that serializes tuples to a a binary format that can be directly
 ...
 */
public class PostgresBinaryTupleWriterSocketEnabled implements TupleWriterSocketEnabled {

  /** The ByteBuffer to write the output. */
  private final DataOutputStream buffer;

  /**
   * Constructs a {@link PostgresBinaryTupleWriterSocketEnabled} object.
   * 
   * @param out the {@link OutputStream} to which the data will be written.
   * @throws IOException if there is an IO exception
   */
  public PostgresBinaryTupleWriterSocketEnabled(OutputStream out) throws IOException {
