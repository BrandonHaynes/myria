...
@JsonSubTypes({
	...
	@Type(name = "DataOutputSocketEnabled", value=DataOutputSocketEnabledEncoding.class),
	@Type(name = "SocketDataOutput", value=SocketDataOutputEncoding.class),
    ...
    @Type(name = "FileScan", value = FileScanSocketEnabledEncoding.class), 
    @Type(name = "Filter", value = FilterEncoding.class),
    @Type(name = "FileScanSocketEnabled", value = FileScanSocketEnabledEncoding.class), 
    ...
    @Type(name = "ImplicitDimensionBinaryFileScan", value = ImplicitDimensionBinaryFileScanEncoding.class),
    @Type(name = "ImplicitDimensionFileScan", value = ImplicitDimensionFileScanEncoding.class),
    ...
    @Type(name = "SciDBOpaqueScan", value = SciDBOpaqueScanEncoding.class),
