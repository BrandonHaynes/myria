...
@JsonSubTypes({
    @Type(name = "Bytes", value = ByteArraySourceSocketEnabled.class), @Type(name = "File", value = FileSourceSocketEnabled.class),
    @Type(name = "URI", value = UriSourceSocketEnabled.class), @Type(name = "Empty", value = EmptySourceSocketEnabled.class),
    @Type(name = "Socket", value = SocketSourceSocketEnabled.class) })
public interface DataSourceSocketEnabled {
  /**
