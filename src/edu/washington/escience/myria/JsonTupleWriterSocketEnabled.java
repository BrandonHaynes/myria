...
/**
 * JsonTupleWriterSocketEnabled is a {@link TupleWriterSocketEnabled} that serializes tuples to JavaScript Object Notation (JSON). The output is a
 ...
 * 
 */
public class JsonTupleWriterSocketEnabled implements TupleWriterSocketEnabled {
  ...
  /**
   * Constructs a {@link JsonTupleWriterSocketEnabled}.
   * 
   * @param output the {@link OutputStream} to which the data will be written.
   */
  public JsonTupleWriterSocketEnabled(OutputStream output) {
     output = edu.washington.escience.myria.operator.DataOutputSocketEnabled.getStream(this, java.io.OutputStream.class);
